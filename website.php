        ...
        <section class="clean-block clean-info dark">
            <div class="container">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6"><img class="img-thumbnail" src="assets/img/web.png"></div>
                    <div class="col-md-6">
                        <h3><strong>Anda Butuh Website Untuk Perusahaan Anda?</strong></h3>
                        <div class="getting-started-info">
                            <p>Dengan Menggunakan Jasa Kami, Anda tidak perlu repot-repot mengeluarkan banyak biaya dan tenaga.<br><br>Hanya dengan Biaya Rp 700.000 Anda sudah bisa mendapatkan Sebuah Website Beserta Domain dan Hosting Selama Satu Tahun.<br><br>Untuk
                                Perawatan dan pengisian content berserta pelayanan konsumen anda, Anda hanya butuh Biaya Rp 1.100.000 untuk satu bulan.&nbsp;</p>
