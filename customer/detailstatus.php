...
$id = $_GET["id"];
$result = mysqli_query($conn, "SELECT * FROM detil_pemesanan, jasa WHERE id_pemesanan = $id and detil_pemesanan.jasa = jasa.id_jasa");
...
<head>
  ...
  <title>
    Dasbor Customer - Detail Status Pemesanan
  </title>
  <!-- Favicon -->
...
<body class="">
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="status.php">Detail Status Pemesanan</a>
        <!-- User -->
        ...
        <div class="col">
          ...
          <div class="card-header bg-white border-0">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Status Pemesanan Detil</h3>
                </div>
              </div>
            </div>
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                <?php $i = 1; ?>
                    <?php while( $detil = mysqli_fetch_assoc($result)) : ?> 
                        <tr>
                            <th scope="row"> <?= $i; ?></th>
                            <td><?= $detil["namaJasa"]; ?>
                            <td><?= $detil["jml_pesan"]; ?></td>
                            <td><?= $detil["total_harga"]; ?></td>
                        </tr>
                    <?php $i++; ?>
                    <?php endwhile; ?>
                </tbody>
