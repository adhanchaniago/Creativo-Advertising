...
WHERE users.username = '$session' and pemesanan.customer = users.id_user and statuspemesanan.id_status = pemesanan.id_status");
...
<head>
  ...
  <title>
    Dasbor Customer - Status Pemesanan
  </title>
  <!-- Favicon -->
...
<body class="">
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="status.php">Status Pemesanan</a>
        <!-- User -->
        ...
        <div class="col">
          ...
          <div class="card-header bg-white border-0">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Status Pemesanan</h3>
                </div>
              </div>
            </div>
