        ...
        <section class="clean-block clean-info dark">
            <div class="container">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6"><img class="img-thumbnail" src="assets/img/yt.png"></div>
                    <div class="col-md-6">
                        <h3><strong>Tak Perlu Endors Ke Channel Orang, Buat Channel Anda Sendiri disini!</strong><br></h3>
                        <div class="getting-started-info">
                            <p>Youtube adalah Sebuah Situs Video Terbesar di Dunia, yang bisa anda manfaatkan untuk Promo!Dengan membuat sebuah channel, anda bisa mempromosikan perusahaan dan produk anda di Youtube, anda tidak perlu bayar mahal mahal untuk
                                sebuah iklan berdurasi panjang, Namun tidak mudah untuk mendatangkan sebuah pelanggan melalui Youtube, Content yang anda buat harus menarik untuk mempermudah menarik Pelanggan<br><br>Dengan Menggunakan jasa kami, anda tidak
                                perlu repot repot membuat content Video, dengan kami hanya Rp 500.000 untuk 1 bulan dalam pembuatan content.</p>
